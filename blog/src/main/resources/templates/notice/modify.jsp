...
<!-- sub contents -->
	...
	<div class="container">
	  ...
	  <form name="notice" method="post" action="/np/modifypro.do" onsubmit="return check()">
	  	<input type ="hidden" name="idx" value="${mvo.getIdx() }">
	  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
			<table class="bord_table">
				<caption class="sr-only">공지사항 수정 표</caption>
				<colgroup>
					<col width="20%">
					<col width="*">
				</colgroup>
				<tbody>
					<tr class="first">
						<th>글쓴이</th>
						<td><input type="text" name="writer" value="${mvo.getWriter()}" readonly="readonly"></td>
					</tr>
					<tr>
						<th>제목</th>
						<td><input type="text" name="title" value="${mvo.getTitle()}"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td><textarea name="content">${mvo.getContent() }</textarea></td>
					</tr>
					<tr>
						<th>첨부</th>
